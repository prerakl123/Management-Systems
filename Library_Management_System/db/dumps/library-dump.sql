...
CREATE TABLE `books` (
  ...
  CONSTRAINT `books_ibfk_2` FOREIGN KEY (`genreid`) REFERENCES `genre` (`id`),
  CONSTRAINT `books_ibfk_3` FOREIGN KEY (`shelfid`) REFERENCES `shelf` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-04-19 11:17:27
